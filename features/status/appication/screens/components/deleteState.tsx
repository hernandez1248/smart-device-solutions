...
import { DeleteStateProvider, useDeleteStateState } from "../../providers/deleteStateProvider";
import State from "../../../domain/entities/state";

interface StateDeleteViewProps {
    stateDelete: State;
    onDeleted: Function;
...
const StateDeleteView: React.FC<StateDeleteViewProps> = ({
    stateDelete,
    onDeleted,
    modalVisible,
    //setModalVisible,
    ...
    useEffect(() => {
        setState(stateDelete)
    }, [stateDelete]);

    
  const confirm = () => {

    setStateProp('[]', stateDelete);
        ...
        <View style={styles.centeredView}>
            ...
            <View style={styles.centeredView}>
              <View style={styles.modalView}>
                ...
                <Text style={styles.title}>¿Estás seguro de que deseas eliminar este estado?</Text>
...
const StateDeleteScreen = (props: StateDeleteViewProps) => (
    <DeleteStateProvider>
        <StateDeleteView {...props} />
    </DeleteStateProvider>
)
...
export default StateDeleteScreen;
